// Sidebar.jsx - VERSION MODIFIÉE
import React from 'react';
import { Home, Utensils, Dumbbell, Calendar, User, Settings, LogOut } from 'lucide-react';

const Sidebar = ({ active = 'dashboard' }) => { // ⬅️ AJOUTER CETTE PROP
  const menuItems = [
    { icon: Home, label: 'Dashboard', href: '/dashboard', key: 'dashboard' },
    { icon: Utensils, label: 'Nutrition', href: '/nutrition', key: 'nutrition' },
    { icon: Dumbbell, label: 'Workout', href: '/workout', key: 'workout' },
    { icon: Calendar, label: 'My Programs', href: '/myprograms', key: 'programs' },
