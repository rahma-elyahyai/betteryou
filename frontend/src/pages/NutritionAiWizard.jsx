...
async function generateNutritionPlan(payload) {
  ...
  // => /nutrition/ai/generate == /api/nutrition/ai/generate
  const res = await api.post("/nutrition/ai/generate", payload, {
...
async function getNutritionWeek(planId) {
  const res = await api.get(`/nutrition/ai/plans/${planId}/week`);
  return res.data;
}
