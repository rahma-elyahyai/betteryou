  ...
  useEffect(() => {
    const fetchPrograms = async () => {
      try {
        ...
        if (selectedProgram && data && data.length > 0) {
          const updatedProgram = data.find(p => p.idNutrition === selectedProgram.idNutrition);
          setSelectedProgram(updatedProgram || data[0]);
        }
      } catch (err) {
  ...
  const EmptyState = () => (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
      <div className="text-center">
        ...
        <button className="px-8 py-3 bg-lime-400 hover:bg-lime-500 text-gray-900 font-semibold rounded-full transition-all duration-300 transform hover:scale-105 flex items-center gap-2 mx-auto">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-4">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-4xl font-bold text-lime-400 mb-4 text-center">My Nutrition Programs</h1>
