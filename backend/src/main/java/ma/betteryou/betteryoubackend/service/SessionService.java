...
public class SessionService {
    ...
    public SessionDetailDto getSessionDetail(Long sessionId) {
        WorkoutSessionR session = sessionRepository.findById(sessionId)
        ...
        List<SessionExerciseR> ses = sessionExerciseRepository.findBySessionIdOrdered(sessionId);
    ...
    public SessionExerciseDetailDto saveExerciseNote(Long sessionId, Long exerciseId, String note) {
        SessionExerciseR se = sessionExerciseRepository.findOne(sessionId, exerciseId)
    ...
    private SessionExerciseDetailDto mapSessionExerciseToDto(SessionExerciseR se) {
        ExerciseR ex = se.getExercise();
