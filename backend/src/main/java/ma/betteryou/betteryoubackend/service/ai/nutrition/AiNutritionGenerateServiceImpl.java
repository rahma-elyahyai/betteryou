...
public class AiNutritionGenerateServiceImpl implements AiNutritionGenerateService {
    ...
    public AiNutritionGenerateResponse generate(AiNutritionGenerateRequest req) {
        ...
        NutritionPlan saved = savePlan(req, user, name, desc);

        return AiNutritionGenerateResponse.builder()
                .nutritionPlanId(saved.getIdNutrition())
                .nutritionName(saved.getNutritionName())
                .objective(saved.getObjective())
                .caloriesPerDay(saved.getCaloriesPerDay())
    ...
    @Transactional
    protected NutritionPlan savePlan(AiNutritionGenerateRequest req, User user, String name, String desc) {
