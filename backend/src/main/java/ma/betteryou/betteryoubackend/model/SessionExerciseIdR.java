...
@Embeddable
public class SessionExerciseIdR implements Serializable {
    ...
    public SessionExerciseIdR() {}

    public SessionExerciseIdR(Long sessionId, Integer orderInSession, Long exerciseId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SessionExerciseIdR)) return false;
        SessionExerciseIdR that = (SessionExerciseIdR) o;
